...
<figure><img class="docimage medium border" src="{{site.media}}/nonref_authentication.svg" alt="Authentication versus authorization" /><figcaption>Authentication and authorization</figcaption></figure>
...
<figure><img class="docimage large" src="{{site.media}}/nonref-docs-preso_apikey.svg" alt="APK keys use a string in a header property to authorize requests" /><figcaption>APK keys use a string in a header property to authorize requests</figcaption></figure>
...
<figure><img class="docimage medium border" src="{{site.media}}/restapi_hmac.svg" alt="HMAC workflow" /><figcaption>HMAC workflow</figcaption></figure>
...
<figure><img class="docimage medium border" src="{{site.media}}/restapi_oauth.svg" alt="OAuth authentication" /><figcaption>OAuth authentication</figcaption></figure>
