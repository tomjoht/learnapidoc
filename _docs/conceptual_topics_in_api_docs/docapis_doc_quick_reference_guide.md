...
<figure><img class="docimage large border" src="{{site.media}}/nonref_quickreference.svg" alt="Quick reference" /><figcaption>Quick reference guides compress the key information into a brief format for easy consumption</figcaption></figure>
