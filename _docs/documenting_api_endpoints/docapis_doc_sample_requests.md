...
<img src="https://s3-us-west-1.amazonaws.com/idratherbewritingmedia.com/images/api/apiref4.png"/>
{% endif %}
...
<a href="http://docs.parseplatform.org/rest/guide/#updating-objects" class="noExtIcon"><img src="https://s3-us-west-1.amazonaws.com/idratherbewritingmedia.com/images/api/parseapirequest.png"/></a>
...
<a class="noExtIcon" href="https://developer.twitter.com/en/docs/accounts-and-users/follow-search-get-users/api-reference/get-friends-list"><img src="https://s3-us-west-1.amazonaws.com/idratherbewritingmedia.com/images/api/twitterrequestexample.png" /></a>
...
<a href="http://docs.citygridmedia.com/display/citygridv2/Places+API" class="noExtIcon"><img src="https://s3-us-west-1.amazonaws.com/idratherbewritingmedia.com/images/api/search_usage_examples.png" alt="CityGrid Places API example" /></a>
...
<a href="https://www.twilio.com/docs/api/rest/making-calls" class="noExtIcon"><img src="https://s3-us-west-1.amazonaws.com/idratherbewritingmedia.com/images/api/twiliocodeexamples.png" alt="Twilio code samples" /></a>
...
<a href="https://clearbit.com/docs?javascript#enrichment-api-combined-api" class="noExtIcon"><img src="https://s3-us-west-1.amazonaws.com/idratherbewritingmedia.com/images/api/clearbitrequestexamples.png" alt="Clearbit code samples" /></a>
...
<a href="https://luckymarmot.com/paw/extensions/" class="noExtIcon"><img src="https://s3-us-west-1.amazonaws.com/idratherbewritingmedia.com/images/api/pawcodegenerators.png" alt="Paw code generator" /></a>
...
<img src="https://s3-us-west-1.amazonaws.com/idratherbewritingmedia.com/images/api/postmangeneratecodesnippet.png" class="medium" alt="Generate code snippet" />

Then select the language you want, such as JavaScript > Jquery AJAX:

<img src="https://s3-us-west-1.amazonaws.com/idratherbewritingmedia.com/images/api/postmancodesnippet.png" class="medium" alt="JavaScript Ajax code snippet" />
...
<a href="https://developer.spotify.com/web-api/console/get-album/" class="noExtIcon"><img src="https://s3-us-west-1.amazonaws.com/idratherbewritingmedia.com/images/api/spotifyapiconsole.png"/></a>

Flickr's API docs also have a built-in API Explorer:

<a href="https://www.flickr.com/services/api/explore/flickr.photos.search" class="noExtIcon"><img src="https://s3-us-west-1.amazonaws.com/idratherbewritingmedia.com/images/api/flickrapiexplorer.png"/></a>

As does the New York Times API:

<a class="noExtIcon" href="http://developer.nytimes.com/article_search_v2.json#/Console/GET/articlesearch.json"><img src="https://s3-us-west-1.amazonaws.com/idratherbewritingmedia.com/images/api/nytimesrequestexample.png"/></a>
...
<a href="https://sendgrid.com/docs/API_Reference/Web_API/blocks.html" class="noExtIcon"><img src="https://s3-us-west-1.amazonaws.com/idratherbewritingmedia.com/images/api/sendgridwarningmessage.png" alt="SendGrid API Explorer warning message" /></a>
...
<a href="https://developer.foursquare.com/docs" class="noExtIcon"><img src="https://s3-us-west-1.amazonaws.com/idratherbewritingmedia.com/images/api/foursquareapiexplorer.png" alt="Foursquare's API Explorer" /></a>
