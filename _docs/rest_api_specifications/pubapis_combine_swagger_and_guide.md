...
What does the code `200` mean? If you go to the [City ID section in the docs](http://openweathermap.org/current#cityid), you'll see a link to download a list of file city codes.
