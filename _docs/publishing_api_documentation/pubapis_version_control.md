...
Collaborating on docs in Git can be a lot more challenging than it initially seems, especially if you're working on the same files. Exactly how much you use Git when collaborating with docs, and in which scenarios tends to be somewhat fuzzy. I recently received a question from a former colleague that hints at some of the challenges in collaborating with Git. My colleague writes,
