...
<figure><img class="docimage large" src="{{site.media}}/limitstodocsascode.svg" alt="Treating docs like code" /><figcaption>Treating docs like code</figcaption></figure>
