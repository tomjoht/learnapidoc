...
<figure><img class="docimage large" src="{{site.media}}/{% if site.kindle %}limitstodocsascode.png{% else %}limitstodocsascode.svg{% endif %}" alt="Treating docs like code" /><figcaption>Treating docs like code</figcaption></figure>
