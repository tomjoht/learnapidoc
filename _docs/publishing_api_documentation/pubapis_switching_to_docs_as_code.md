...
Some writers already had this background, while others had to learn it. Although we all ended up learning the git commands, I'm not sure everyone actually used the same processes for pulling, pushing, and merging content (there's a lot of variety you can choose from).
