...
2.  Replace the contents of weatherdata.md with the following content: [aviator-weatherdata.txt](http://idratherbewriting.com/learnapidoc/assets/files/aviator-weatherdata.txt).
