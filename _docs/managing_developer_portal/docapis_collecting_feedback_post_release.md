...
This side position is becoming more common, but in tests that I've done, most people don't see the feedback button on the side. The comment form at the bottom was used much more than the feedback button on the side (a ratio of 10:1 more, if not more).
