...
I've tried different processes for reviewing content, and while I'm wary of making sweeping generalizations about reviewing practices across companies, I have more or less realized what works and doesn't. Here's what doesn't work:
...
So in general, bake time into the review meeting to allow people to read the content during the meeting. Also, the more executive the reviewer, the more they expect you to present them with content to read on the spot and then take notes as they provide feedback.
...
It might look like you have a full week to schedule people for reviews, but there are optimal days and times to review content. At all costs, avoid Monday mornings. During this time, people are still recovering from the weekend.

People in other time zones (India, Australia, Europe) have already been operating for a full day (sending emails, raising issues, and generally working), so if you're in the Pacific time zone, on Monday morning you're slogging through email, issues, and other tasks surfaced by these other groups. People are generally grumpy on Monday mornings, and if they already dislike reading and reviewing documentation, by combining the Monday morning grumpy attitude with this meeting focus, you're in for a real experience.

Another time to avoid is Friday afternoon. By this time, people are usually checked out mentally for the week. From about 2 pm on Fridays, it gets quiet at companies. Some people have already completed the week (especially people in time zones that are a day ahead). Additionally, some people leave early for weekend trips or other engagements, or they're just tired from a week of work. The absolute worst thing you can do is schedule a 4 pm Friday meeting for an hour. People will hate you for it.

Another time to avoid is lunchtime. Scheduling a meeting from 12-1 pm is considered somewhat rude, even if people don't eat lunch with anyone. Many people do have lunch engagements and prefer to spend this time interacting socially, but even with loners or workaholics who prefer to eat at their desks, they usually want a little personal time to relax and be idle. By booking their lunchtime, you incur their displeasure and might feel this during the tone and attitudes you encounter during the review.
...
When you spot a quiet person, ask them politely for their input. For example, “Sam, what's your opinion on this?” You'll find that either (1) they're quiet because they actually don't have an opinion or any thoughts, in which case they'll usually just agree with what everyone else is saying. Or (2) they may start to express some feedback that they were holding back, for whatever reason, and it's actually refreshing and insightful. Look to balance out the room like this.

(By the way, this tip applies for all types of meetings, not just doc review meetings. See [Quiet: The Power of Introverts in a World That Can't Stop Talking](https://www.amazon.com/Quiet-Power-Introverts-World-Talking/dp/0307352153) for more on introverts in the workplace.)

If the reviewers run out of questions, bring out your list of questions and start asking your questions one by one. It's at this point that you start to control the focus and flow of the meeting. You know the weak spots and gray areas of your docs better than most reviewers do. Spend time addressing these gray areas.

## 4.2 Incorporate edits {#incorporate_edits}

After the meeting, incorporate edits into the documentation. Make a tally of all the changes you made, and list these changes in the revision so that others can see that their voices were heard and their feedback was incorporated. When people see that their feedback has been incorporated into the next revision, it helps them feel that their input and participation in the doc review was worthwhile, and they will be more likely to provide feedback in the future. If you don't incorporate their feedback, consider indicating reasons why in your revision notes.

It's worth noting that not all feedback is worth incorporating. Sometimes reviewers are wrong, or the notion they describe during the meeting might have sounded all right when vocalized in the air (and without more context), but it really doesn't work when you try to incorporate it. Or you might simply disagree because you have more product information and a better understanding of partners and use cases than the reviewer does. This brings up another point: your role as a product aligner.

### Tech writers as product aligners {#product_aligners}

Occasionally you will find that different groups have conflicting perspectives about what the documentation should say. For example, Engineering might want to be much more hesitant about supporting a feature that Product Management wants to advertise in an extremely visible way. Or Business Development (BD) might want you to avoid including too many technical details, instead of focusing more on a decision-maker audience than an engineering integrator audience. In contrast, your partner engineers might want you to include more technical details, even including min and max values that no one knows and which BD doesn't care about.

Writing documentation serves two hidden purposes: (1) it raises awareness about conflicting perspectives on products, and (2) it forces people to come to an agreement. As writers, because you're the instrument creating this alignment through content, you get caught in the middle. As long as you keep in mind that writing documentation serves as a forcing function for product alignment, you won't be surprised and uncomfortable when these issues arise.
...
Finally, I want to point out that reviewing docs can be one of the more fun and interesting aspects of the tech writer's job. You might have been working alone on this doc for weeks, but the review period allows you to dip your toes into a more social mode. You get to meet people, interact, engage in discussions, and they get to know you and read your work.

It can be exhilarating if they like the docs, and also exhausting. You might get feedback that discourages you because you'll need to track down information, rework sections you thought were fine, or address other large gaps that will require more time and effort than you wanted to expend. Even so, it's worth it. Other times, reviewers might have very little to say except praise for a job well done.

Overall, reviewing docs is a critical part of the process for writing documentation, especially for extremely technical subjects.

### When does the review cycle end {#when_does_it_end}

The review cycle ends when you release the product, basically, or if there's no release timeframe, when your edits approach zero with each revision. With each review and edit, there should be fewer edits to make from subsequent reviewers.The trend of edits needed goes down. At some point, as you're reading and rereading the docs, you end up changing only minor cosmetic style and grammar. When you hit this point, recognize that your changes are no longer moving the needle anymore. You've addressed content accuracy, information about user journeys, and other higher-level concerns.
