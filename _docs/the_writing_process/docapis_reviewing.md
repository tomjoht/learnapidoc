...
<figure><img class="docimage" src="{{site.media}}/{% if site.kindle %}review_process.png{% else %}review_process.svg{% endif %}" alt="The review process is iterative. After each review, incorporate the edits before the next review." /><figcaption>The review process is iterative. After each review, incorporate the edits before the next review.</figcaption></figure>
