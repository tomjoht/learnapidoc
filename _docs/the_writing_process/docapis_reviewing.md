...
{% include course_image.html filename="review_process" ext_print="png" ext_web="svg" alt="The review process is iterative. After each review, incorporate the edits before the next review." caption="The review process is iterative. After each review, incorporate the edits before the next review." %}
