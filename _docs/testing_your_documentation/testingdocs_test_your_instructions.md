...
I used Jekyll to build my feed. (You can view my JSON-based feed at [podcast.writethedocs.org/fab.json](http://podcast.writethedocs.org/fab.json).) The most difficult part in setting up this feed was configuring the `recommendations` object. Each video has some `tags`. The `recommendations` object needed to show other videos that have the same tag. Getting the JSON valid there was challenging, and I relied on some support from the Jekyll forum.
...
<a href="https://www.amazon.com/Id-Rather-Be-Writing-Podcast/dp/B06Y23TNC4/ref=sr_1_1?s=mobile-apps&ie=UTF8&qid=1491708630&sr=1-1&keywords=write+the+docs" class="noExtIcon"><img src="images/writethedocastfiretvapp.png" />
