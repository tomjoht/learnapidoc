...
<figure><img class="docimage large" src="{{site.media}}/restapi_restapi.svg" alt="General model of a REST API" /><figcaption>General model of a REST API</figcaption></figure>
...
<figure><img class="docimage medium" src="{{site.media}}/restapi_www.svg" alt="Web as REST API" /><figcaption>Web as REST API</figcaption></figure>
