...
<figure>
{% if site.format == "pdf" or site.format == "kindle" %}<img src="https://s3-us-west-1.amazonaws.com/idratherbewritingmedia.com/images/api/restapi_apidoc.png" alt="Response and request model for REST APIs" />
{% elsif site.format == "web" %}<img class="medium" src="https://s3-us-west-1.amazonaws.com/idratherbewritingmedia.com/images/api/restapi_apidoc.svg" alt="Response and request model for REST APIs" />
{% endif %}
