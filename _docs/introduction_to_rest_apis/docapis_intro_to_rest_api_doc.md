...
This course focuses mostly on REST APIs because REST APIs are more popular and in demand, and because they're also more accessible to technical writers. You don't need to know a specific programming language to document REST APIs. And REST is becoming the most common type of API anyway.
...
The key statistic in this passage is that "59% of organizations began developing APIs in the last five years." If you look at their [2016 State of API report](https://static1.smartbear.co/smartbear/media/ebooks/state-of-api-report-2016.pdf), which surveyed 2,300 professionals, you find similar growth rates:
...
This is astounding and suggests that the market for API *documentation* is likewise expanding. One could also assume that 59% of organizations began developing API documentation in the last five years as well. API development is clearly an area that is somewhat new for many companies, and the directions, methods, and other paths through this new territory aren't clear. In fact, the State of API 2019 report notes that companies are resoundingly asking for more standardization in this space.
...
The [State of API 2019 report](https://static1.smartbear.co/smartbearbrand/media/pdf/smartbear_state_of_api_2019.pdf) found that "Accurate and detailed documentation" ranks third in importance:
...
{% include course_image.html url="https://static1.smartbear.co/smartbear/media/ebooks/state-of-api-report-2016.pdf" size="" border="" filename="mostimportant2016" ext_print="png" ext_web="png" alt="Documentation ranks sixth in importance" caption="Documentation ranks sixth in importance, p.19" %}

An even earlier survey conducted by Programmableweb in 2013 (which included 250 respondents) found that "Complete and accurate documentation" actually ranked as the most important factor in an API ([API Consumers Want Reliability, Documentation and Community](http://www.programmableweb.com/news/api-consumers-want-reliability-documentation-and-community/2013/01/07)).
...
Despite what might seem like a clear mandate for excellent API docs, unfortunately documentation efforts still aren't a huge priority. The [2019 State of API](https://static1.smartbear.co/smartbearbrand/media/pdf/smartbear_state_of_api_2019.pdf) report found the following:

> **Generating API documentation with OAS is the top method for
documenting APIs**
>
...
Again, the question here is a bit vague. Exactly what is a "formal documentation process"? If someone asked me this, I am not exactly sure how I would answer. As a tech writer working with API teams, *I am* the process, to an extent. I define the organization and content of the docs, the way the content is reviewed and approved, how the content is published and delivered to customers, etc. Is that what the question is asking? Probably not. Given that one of Smartbear's key products is [SwaggerHub](pubapis_swaggerhub_smartbear.html), which auto-generates reference documentation from the OpenAPI spec, my guess is that a formal documentation process refers to generating docs from the OpenAPI spec.
